...
<div id="deleteAllModal" class="fixed inset-0 bg-gray-600 bg-opacity-50 overflow-y-auto h-full w-full hidden z-50">
    <div class="relative top-20 mx-auto p-5 border w-96 shadow-lg rounded-md bg-white dark:bg-gray-800">
        <div class="mt-3">
            <div class="flex items-center justify-between mb-4">
                <h3 class="text-lg font-medium text-red-600 dark:text-red-400">Delete All Equipment</h3>
            ...
            <div class="mb-6">
                ...
                <p class="text-sm text-gray-700 dark:text-gray-300">
                    This will permanently delete <strong>ALL</strong> equipment records from the database. 
                    All data will be lost and cannot be recovered.
                </p>
            </div>

            <form action="{{ route('master.equipment.delete-all') }}" method="POST">
                @csrf
                @method('DELETE')
                <div class="flex gap-3">
