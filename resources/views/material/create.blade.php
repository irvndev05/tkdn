...
<div class="space-y-6">
    ...
    <div class="max-w-4xl">
        <div class="card">
            ...
            <div class="card-body">
                <form action="{{ route('master.material.store') }}" method="POST" class="space-y-6" id="materialForm">
                    @csrf
                    ...
                    <div class="grid grid-cols-1 md:grid-cols-2 gap-6">
                        <div>
                            ...
                            <div class="relative">
                                ...
                                <input type="text" name="unit" id="unit" required class="form-input pl-10 @error('unit') border-red-500 focus:ring-red-500 focus:border-red-500 @enderror" value="{{ old('unit') }}" placeholder="e.g., pcs, kg, m">
                            </div>
                            @error('unit')
                            <p class="mt-1 text-sm text-red-600 dark:text-red-400">{{ $message }}</p>
                            @enderror
...
<<<<<<< HEAD
                                <input type="number" name="tkdn" id="tkdn" step="0.01" min="0" max="100" class="form-input pl-10 @error('tkdn') border-red-500 focus:ring-red-500 focus:border-red-500 @enderror" value="{{ old('tkdn', 100) }}" placeholder="Contoh: 70.5">
=======
